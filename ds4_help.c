...
static void print_sampling(FILE *fp, const help_colors *c, bool full, ds4_help_tool tool) {
    ...
    para(fp, c, "GLM CLI and agent runs default to temperature 1.0, top-p 0.95, and min-p 0 unless those options are set explicitly. Laguna defaults to temperature 1.0, top-k 20, top-p 1.0, and min-p 0. Explicit options always win.");
