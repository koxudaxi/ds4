...
QWEN35_GDN_METAL_TEST := tests/test_qwen35_gdn_metal
...
ifeq ($(UNAME_S),Darwin)
tests/test_qwen35_gdn_metal.o: tests/test_qwen35_gdn_metal.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen35_gdn_metal.c

$(QWEN35_GDN_METAL_TEST): tests/test_qwen35_gdn_metal.o ds4_metal.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

.PHONY: test-qwen35-gdn-metal
test-qwen35-gdn-metal: $(QWEN35_GDN_METAL_TEST)
	./$(QWEN35_GDN_METAL_TEST)

QWEN35_ATTN_METAL_TEST := tests/test_qwen35_attn_metal

tests/test_qwen35_attn_metal.o: tests/test_qwen35_attn_metal.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen35_attn_metal.c

$(QWEN35_ATTN_METAL_TEST): tests/test_qwen35_attn_metal.o ds4_metal.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)
...
tests/test_qwen35_tokenizer: tests/test_qwen35_tokenizer.o ds4_cpu_test_hooks.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
...
tests/test_qwen35_moe.o: tests/test_qwen35_moe.c ds4.h
	$(CC) $(CFLAGS) -I. -DDS4_NO_GPU -c -o $@ $<

tests/test_qwen35_moe: tests/test_qwen35_moe.o ds4_cpu_test_hooks.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)

.PHONY: test-qwen35-moe
test-qwen35-moe: tests/test_qwen35_moe
	./tests/test_qwen35_moe

tests/test_qwen35_e2e.o: tests/test_qwen35_e2e.c
	$(CC) $(CFLAGS) -I. -DDS4_NO_GPU -c -o $@ $<

tests/test_qwen35_e2e: tests/test_qwen35_e2e.o ds4_cpu_test_hooks.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
